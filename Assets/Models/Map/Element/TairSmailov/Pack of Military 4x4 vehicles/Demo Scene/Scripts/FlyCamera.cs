...
public class FlyCamera : MonoBehaviour
{
    ...
    float shiftAdd = 35f;  // Multiplied by how long shift is held.  Basically running.
    float maxShift = 50; // Maximum speed when holding shift.
    float camSens = .1f;  // Camera sensitivity by mouse input.
